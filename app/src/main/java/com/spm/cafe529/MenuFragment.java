...
public class MenuFragment extends MainActivity.PlaceholderFragment implements View.OnClickListener{
    ...
    private void getInitData () {
        ...
        mHelper.putMenu(db, "Greentealatte", 4500, "/storage/emulated/0/Download/image/Greentealatte.jpeg", "Coffee");
        mHelper.putMenu(db, "Mochachino", 4500, "/storage/emulated/0/Download/image/Mochachino.jpeg", "Coffee");
        mHelper.putMenu(db, "Macchiato", 4500, "/storage/emulated/0/Download/image/Caramelmacchiato.jpeg", "Coffee");
        mHelper.putMenu(db, "Muffin", 3000, "/storage/emulated/0/Download/image/Muffin.jpeg", "Coffee");
        mHelper.putMenu(db, "Honeybread", 5000, "/storage/emulated/0/Download/image/Honeybread.jpeg", "Coffee");
    }
