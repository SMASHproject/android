...
public class WishlistAdapter extends ArrayAdapter<WishItem> implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //button
            TextView plusBtn = (TextView) convertView.findViewById(R.id.plus_btn);
            TextView minusBtn = (TextView) convertView.findViewById(R.id.minus_btn);
    ...
    public void onClick(View v) {
        ...
        if(getItem(position).calcItem(type)) {
            if (getItem(position).getItemCount() == 0)
